...
Four directories containing example datasets:
	...
	14_subtree_supertree -> mammal data (4,705 mammal species dataset) from Álvarez-Carretero et al. (2022).
	1000_genetree_speciestree -> mammal data (1,00 genes ~5% missing seqs /gene aln dataset) from Álvarez-Carretero et al. (2022).
